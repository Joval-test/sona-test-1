...
import os
import base64
from core.data_processor import process_company_files, process_company_urls, process_user_files, display_file_details
        ...
        if st.button("Save Email Settings"):
            if email and password:
                ...
                try:
                    ...
                    # Force Streamlit to rerun to load new secrets
                    st.rerun()
